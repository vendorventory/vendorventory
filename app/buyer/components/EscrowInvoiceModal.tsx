...
export function EscrowInvoiceModal({ isOpen, onClose, invoice }: InvoiceDetailsModalProps) {
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-y-6 gap-x-8">
              ...
              <div>
                ...
                <p className="text-xs font-black text-blue-600 mt-1 underline underline-offset-4">{invoice.paymentStatus}</p>
              </div>
