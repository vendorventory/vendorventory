  ...
  const faqs = [
    {
      ...
      a: "Yes! Signing up and listing your products or services is completely free for the vendor. We only charge the buyer a small transaction fee (0.75%) when buyers successfully make payment."
    },
    {
