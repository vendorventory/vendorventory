...
// Typography setup to match your landing page
const arimo = Arimo({ 
  subsets: ['latin'], 
    ...
    <div className={`min-h-screen flex ${arimo.variable} ${arimo.className}`}>
      ...
      <div className="hidden lg:flex w-1/2 relative bg-[#152570] flex-col justify-between p-16 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          {/* Note: Replace '/images/vendor-bg.jpg' with your actual image path */}
      ...
      <div className="w-full lg:w-1/2 bg-[#F8FAFC] flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-[520px] bg-white rounded-[20px] shadow-xl shadow-slate-200/60 p-8 md:p-12">
          ...
          <div className="mb-10">
            <h2 className="text-3xl font-medium text-[#152570] mb-2">Create your Vendor Account</h2>
            <p className="text-[#4A5565]">Sell confidently with secure payments</p>
          </div>
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-[#152570] block">Business / Store Name</label>
              <div className="relative">
                <Store className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={20} />
                <input 
                  type="text" 
                  placeholder="Enter your business name"
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg py-3.5 pl-12 pr-4 text-[#4A5565] placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#152570]/10 focus:border-[#152570] transition-all"
                />
              </div>
            </div>
            ...
            {/* Password */}
            <div className="space-y-2">
              <label className="text-sm font-bold text-[#152570] block">Password</label>
              <div className="relative">
            ...
            {/* Confirm Password */}
            <div className="space-y-2">
              <label className="text-sm font-bold text-[#152570] block">Confirm Password</label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={20} />
                <input 
